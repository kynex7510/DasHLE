...
using namespace internal::ielf::constants;

inline const auto& getHeader = &internal::ielf::getHeader<Config>;
inline const auto& getSegments = &internal::ielf::getSegments<Config>;
inline const auto& getSegmentAllocBase = &internal::ielf::getSegmentAllocBase<Config>;
inline const auto& getSegmentAllocSize = &internal::ielf::getSegmentAllocSize<Config>;
inline const auto& getDynEntries = &internal::ielf::getDynEntries<Config>;
